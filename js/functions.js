! function(e, i, n) { "object" == typeof module && module && "object" == typeof module.exports ? module.exports = n : (e[i] = n, "function" == typeof define && define.amd && define(i, [], function() { return n })) }(this, "jRespond", function(e, i, n) {
    ...
    return function(e) {
        var i = [],
            ...
            c = function(e) { if ("object" == typeof e) { if (e.join().indexOf(l) >= 0) return !0 } else { if ("*" === e) return !0; if ("string" == typeof e && l === e) return !0 } },
            g = function() {
        ...
        return g(), {
            ...
            getBreakpoint: function() { return l }
        }
    }
}(0, this.document));
    ...
    function() {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function(i, n) {
            let t = (new Date).getTime(),
                s = Math.max(0, 16 - (t - e)),
                l = window.setTimeout(function() { i(t + s) }, s);
            return e = t + s, l
...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        execPlugin: function(i, n) {
            if (n.trigger) { let i = setInterval(function() { Function("return " + n.pluginfn)() && (e(window).trigger(n.trigger), clearInterval(i)) }, 1e3) }
            n.execfn && (n.trigger ? e(window).on(n.trigger, function() { SEMICOLON.initialize.execFunc(n.execfn, window, i) }) : SEMICOLON.initialize.execFunc(n.execfn, window, i)), n.class && o.addClass(n.class)
        },
        ...
        modal: function(e) {
            let i = { element: e, default: ".modal-on-load", file: "plugins.lightbox.js", error: "plugins.lightbox.js: Plugin could not be loaded", execfn: "SEMICOLON_modalInit", pluginfn: '$().magnificPopup && typeof Cookies !== "undefined"', trigger: "pluginLightboxReady", class: "has-plugin-lightbox" };
            SEMICOLON.initialize.functions(i)
        },
        ...
        menufunctions: function() {
            ...
            a = Number(a), i = n.children(".sub-menu-trigger"), o.hasClass("device-xl") || o.hasClass("device-lg") ? (setTimeout(function() { y.length > 0 && y.css({ height: u.outerHeight() }), SEMICOLON.header.includeOffset() }, 1e3), M.find(l).css({ display: "" })) : c.css({ "margin-top": "" }), o.hasClass("overlay-menu") && M.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? t.off("click").on("click", function(i) {
                let n = e(this);
            ...
            }) : o.hasClass("side-header") && M.hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs") ? (i.removeClass("icon-rotate-90"), e(".menu-item").find(l).filter(":not(:animated)").stop(!0, !0).slideUp(a, function() { o.toggleClass("primary-menu-open", !1) }), i.off("click").on("click", function(i) {
                let n = e(this);
            ...
            })) : (o.hasClass("overlay-menu") || o.hasClass("side-header")) && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? (M.find(l).stop(!0, !0).slideUp(a), e(".menu-item").hover(function(i) { e(this).children(s).stop(!0, !0).slideDown(a) }, function() { e(this).children(s).stop(!0, !0).slideUp(a) })) : M.hasClass("on-click") && t.off("click").on("click", function(i) {
                let n = e(this);
            ...
            }), (e(".top-links").hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && e(".top-links-item:has(.top-links-sub-menu,.top-links-section) > a").on("click", function(i) { e(this).parents("li").siblings().find(".top-links-sub-menu,.top-links-section").removeClass("d-block"), e(this).parent("li").children(".top-links-sub-menu,.top-links-section").toggleClass("d-block"), i.preventDefault() }), SEMICOLON.header.menuInvert(e(".top-links-section")), e("#primary-menu-trigger").off("click").on("click", function() { return (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && (M.find(".mobile-primary-menu").length > 0 ? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(a), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block")) : (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(a), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))), o.toggleClass("primary-menu-open"), !1 }), e(".menu-container:not(.mobile-primary-menu)").css({ display: "" }), (o.hasClass("device-xl") || o.hasClass("device-lg")) && M.find(".mobile-primary-menu").removeClass("d-block")
        },
        ...
        sliderDimensions: function() {
            ...
            if (o.hasClass("device-xl") || o.hasClass("device-lg")) {
                if (setTimeout(function() { n.height(e), l && (e = U.find(".slider-inner").children().first().outerHeight(), U.height(e), n.height(e)) }, 500), l) {
        ...
        sliderParallax: function() {
            ...
            let e, i, n = SEMICOLON.slider.sliderParallaxOffset(),
                l = U.outerHeight();
            t = window.scrollX, s = window.scrollY, !o.hasClass("device-xl") && !o.hasClass("device-lg") || SEMICOLON.isMobile.any() ? U.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (l + n + 50 > s ? (U.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), s > n ? U.find(".slider-inner").length > 0 ? (e = -.4 * (s - n), i = -.15 * (s - n), SEMICOLON.slider.sliderParallaxSet(0, e, ie), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : (e = (s - n) / 1.5, i = (s - n) / 7, SEMICOLON.slider.sliderParallaxSet(0, e, Z), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : U.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee))) : U.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible"), requestAnimationFrame(function() { SEMICOLON.slider.sliderParallax(), SEMICOLON.slider.sliderElementsFade() }))
        },
        sliderElementsFade: function() {
            if (U.length < 1) return !0;
            if (!o.hasClass("device-xl") && !o.hasClass("device-lg") || SEMICOLON.isMobile.any()) U.find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 });
            else {
                SEMICOLON.slider.sliderParallaxOffset();
                let e, i = U.outerHeight();
                e = d.hasClass("transparent-header") || o.hasClass("side-header") ? 100 : 0, U.filter(".slider-parallax-visible").find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 - 1.85 * (s - e) / i })
            }
        },
    ...
    }, SEMICOLON.isMobile = { Android: function() { return navigator.userAgent.match(/Android/i) }, BlackBerry: function() { return navigator.userAgent.match(/BlackBerry/i) }, iOS: function() { return navigator.userAgent.match(/iPhone|iPad|iPod/i) }, Opera: function() { return navigator.userAgent.match(/Opera Mini/i) }, Windows: function() { return navigator.userAgent.match(/IEMobile/i) }, any: function() { return SEMICOLON.isMobile.Android() || SEMICOLON.isMobile.BlackBerry() || SEMICOLON.isMobile.iOS() || SEMICOLON.isMobile.Opera() || SEMICOLON.isMobile.Windows() } }, SEMICOLON.customization = { onReady: function() {}, onLoad: function() {}, onResize: function() {} }, SEMICOLON.documentOnResize = { init: function() { SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.slider.sliderDimensions(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.customization.onResize(), L = a.width() } }, SEMICOLON.documentOnReady = {
        init: function() {
            SEMICOLON.initialize.init(), SEMICOLON.header.init(), (W.length > 0 || Q.length > 0) && SEMICOLON.slider.init(), V.length > 0 && SEMICOLON.portfolio.init(), SEMICOLON.widget.init(), SEMICOLON.documentOnReady.windowscroll(), SEMICOLON.customization.onReady(), o.hasClass("adaptive-color-scheme") && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches && o.toggleClass("dark", !0), window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function(e) { e.matches ? o.toggleClass("dark", !0) : o.toggleClass("dark", !1) })), o.off("click").on("click", 'a[href*="#"]', function() { a.on("beforeunload", function() { a.scrollTop(0) }) });
            let i = location.hash;
        ...
        windowscroll: function() {
            ...
            $.length > 0 && (q.css({ height: $.find("#page-menu-wrap").outerHeight() }), setTimeout(function() { d.length > 0 && !d.hasClass("no-sticky") && (o.hasClass("device-xl") || o.hasClass("device-lg") || "true" == p) ? (se = $.offset().top - u.outerHeight(), s.appendChild(l), n = "#page-menu.sticky-page-menu:not(.dots-menu) #page-menu-wrap { top: " + t + "px; }", l.type = "text/css", l.appendChild(document.createTextNode(n))) : se = $.offset().top }, 1e3)), SEMICOLON.header.stickyMenu(te), SEMICOLON.header.stickyPageMenu(se), window.addEventListener("scroll", function() { SEMICOLON.initialize.goToTopScroll(), e("body.open-header.close-header-on-scroll").removeClass("side-header-open"), SEMICOLON.header.stickyMenu(te), SEMICOLON.header.stickyPageMenu(se), SEMICOLON.header.logo() }), window.addEventListener("DOMContentLoaded", onScrollSliderParallax, !1), a.scrollEnd(function() {
                let e = u.outerHeight();
